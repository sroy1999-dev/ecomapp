    ...
    <div className='bg-slate-200 p-2 flex gap-4 rounded border border-slate-300'>
     ...
     <div className='flex flex-col gap-1 w-full'>
        <div className='flex justify-between'>
            ...
            <div className='cursor-pointer text-slate-700 hover:text-red-600' onClick={handleDeleteProduct}>
                <AiFillDelete />
            </div>
        </div>
      ...
      <div className='flex justify-between'>
       <div className='flex gap-3 items-center'>
        <button className='bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1' onClick={increaseQuantity}><TbPlus /></button>
        <p className='font-semibold p-1'>{qty}</p>
        <button className='bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1' onClick={decreaseQuantity}><TbMinus /></button>
       </div>
